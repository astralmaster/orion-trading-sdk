...
function calculateNetworkFee(_ref2) {
  ...
  var gasPriceEth = new BigNumber(ethers.utils.formatUnits(gasPriceWei, 'ether'));
  var gasLimit;
...
function getTokenContracts(chain) {
  ...
  for (var name in tokens) {
    ...
    var tokenContract = new ethers.Contract(tokenAddress, erc20ABI, chain.signer);
      ...
      return runtime_1.wrap(function _callee7$(_context7) {
        while (1) {
          switch (_context7.prev = _context7.next) {
            ...
            case 3:
              wei = _context7.sent;
              return _context7.abrupt("return", new BigNumber(ethers.utils.formatEther(wei)));
        ...
        while (1) {
          switch (_context12.prev = _context12.next) {
            ...
            case 11:
              ...
              _context12.next = 15;
              return this.approve(currency, ethers.constants.Zero.toString(), gasPriceWei);

            case 15:
              return _context12.abrupt("return", this.approve(currency, ethers.constants.MaxUint256.toString(), gasPriceWei));
      ...
      return runtime_1.wrap(function _callee13$(_context13) {
        while (1) {
          switch (_context13.prev = _context13.next) {
            case 0:
              _context13.next = 2;
              return contract.populateTransaction.approve(this.signer.address, ethers.constants.MaxUint256);
...
var Exchange = /*#__PURE__*/function () {
  function Exchange(chain) {
    this.chain = chain;
    this.exchangeContract = new ethers.Contract(this.chain.blockchainInfo.exchangeContractAddress, exchangeABI, this.chain.signer);
  }
  ...
  _proto.parseContractBalance = function parseContractBalance(total8, locked) {
    var total = ethers.utils.formatUnits(ethers.BigNumber.from(total8.toString()), EXCHANGE_ORDER_PRECISION);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return _context.abrupt("return", signTypedMessage(bufferKey, msgParams, 'V4'));
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            bufferKey = Buffer.from(signer.privateKey.substr(2), 'hex');
            return _context2.abrupt("return", signTypedMessage(bufferKey, msgParams, 'V4'));
...
export { Chain, Constants, Exchange, Helpers, Models, OrionAggregator, Tokens$1 as Tokens, WS };
//# sourceMappingURL=orion-trading-sdk.esm.js.map
